...
#[sea_orm(schema_name = "public", table_name = "task_model")]
pub struct Model {
...
pub enum RelatedEntity {
	#[sea_orm(entity = "super::buissness_rule::Entity")]
	BuissnessRule,
	#[sea_orm(entity = "super::do_while::Entity")]
	DoWhile,
	#[sea_orm(entity = "super::dynamic::Entity")]
	Dynamic,
	#[sea_orm(entity = "super::dynamic_fork::Entity")]
	DynamicFork,
	#[sea_orm(entity = "super::event::Entity")]
	Event,
	#[sea_orm(entity = "super::fork::Entity")]
	Fork,
	#[sea_orm(entity = "super::get_signed_jwt::Entity")]
	GetSignedJwt,
	#[sea_orm(entity = "super::get_workflow::Entity")]
	GetWorkflow,
	#[sea_orm(entity = "super::http::Entity")]
	Http,
	#[sea_orm(entity = "super::human::Entity")]
	Human,
	#[sea_orm(entity = "super::inline::Entity")]
	Inline,
	#[sea_orm(entity = "super::join::Entity")]
	Join,
	#[sea_orm(entity = "super::json_transform::Entity")]
	JsonTransform,
	#[sea_orm(entity = "super::set_variable::Entity")]
	SetVariable,
	#[sea_orm(entity = "super::simple::Entity")]
	Simple,
	#[sea_orm(entity = "super::sql::Entity")]
	Sql,
	#[sea_orm(entity = "super::start_workflow::Entity")]
	StartWorkflow,
	#[sea_orm(entity = "super::sub_workflow::Entity")]
	SubWorkflow,
	#[sea_orm(entity = "super::switch::Entity")]
	Switch,
	#[sea_orm(entity = "super::task_config::Entity")]
	TaskConfig,
	#[sea_orm(entity = "super::task_definition::Entity")]
	TaskDefinition,
	#[sea_orm(entity = "super::task_execution_log::Entity")]
	TaskExecutionLog,
	#[sea_orm(entity = "super::terminate_task::Entity")]
	TerminateTask,
	#[sea_orm(entity = "super::terminate_workflow::Entity")]
	TerminateWorkflow,
	#[sea_orm(entity = "super::update_secret::Entity")]
	UpdateSecret,
	#[sea_orm(entity = "super::update_task::Entity")]
	UpdateTask,
	#[sea_orm(entity = "super::wait::Entity")]
	Wait,
	#[sea_orm(entity = "super::wait_for_webhook::Entity")]
	WaitForWebhook,
}
