...
pub struct BuilderContext {
	...
	pub guards_graphql: GuardsConfig<FnGuardGraphQL>,
	pub guards_proto: GuardsConfig<FnGuardProto>,
	pub types: TypesMapConfig,
	pub filter_types_graphql: GraphQLFilterTypesMapConfig,
	pub filter_types_proto: ProtoFilterTypesMapConfig,
	// is_skipped function
	// naming function
}
