//! Source code: https://github.com/actix/actix-extras
...
pub trait ProtoBufResponseBuilder {
	...
	fn protobuf_vec<T: Message>(&mut self, values: Vec<T>) -> Result<HttpResponse, Error>;
}
...
mod tests {
	...
	async fn test_protobuf_message() {
		...
		let (req, mut pl) = TestRequest::get()
			...
			.to_http_parts();
		let protobuf = ProtoBufMessage::<MyObject>::new(&req, &mut pl).limit(100).await;
