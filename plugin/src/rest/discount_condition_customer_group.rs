...
#[derive(Deserialize)]
pub struct DiscountConditionCustomerGroupParmns {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/discount_condition_customer_group")
			.route("/", web::get().to(GetDiscountConditionCustomerGroup::route))
			.route("/", web::post().to(CreateDiscountConditionCustomerGroup::route))
			.route("/list", web::get().to(ListDiscountConditionCustomerGroup::route))
			.route("/{id}", web::put().to(UpdateDiscountConditionCustomerGroup::route))
			.route("/{id}", web::get().to(DeleteDiscountConditionCustomerGroup::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetDiscountConditionCustomerGroup {
...
impl GetDiscountConditionCustomerGroup {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetDiscountConditionCustomerGroup>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetDiscountConditionCustomerGroup::default(),
		};
		let mut query = DiscountConditionCustomerGroup::find();
		if let Some(customer_group_id) = &model.customer_group_id {
			query = query.filter(
				DiscountConditionCustomerGroupColumn::CustomerGroupId.eq(customer_group_id.clone()),
			);
		}
		if let Some(condition_id) = &model.condition_id {
			query = query
				.filter(DiscountConditionCustomerGroupColumn::ConditionId.eq(condition_id.clone()));
		}
		if let Some(created_at) = &model.created_at {
			query = query
				.filter(DiscountConditionCustomerGroupColumn::CreatedAt.eq(created_at.clone()));
		}
		if let Some(updated_at) = &model.updated_at {
			query = query
				.filter(DiscountConditionCustomerGroupColumn::UpdatedAt.eq(updated_at.clone()));
		}
		if let Some(metadata) = &model.metadata {
			query =
				query.filter(DiscountConditionCustomerGroupColumn::Metadata.eq(metadata.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListDiscountConditionCustomerGroup {
	pub customer_group_id: Option<String>,
	pub condition_id: Option<String>,
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
...
impl ListDiscountConditionCustomerGroup {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListDiscountConditionCustomerGroup>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListDiscountConditionCustomerGroup::default(),
		};
		let mut query = DiscountConditionCustomerGroup::find();
		if let Some(customer_group_id) = &model.customer_group_id {
			query = query.filter(
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreateDiscountConditionCustomerGroup {
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
	pub metadata: Option<Json>,
}

impl CreateDiscountConditionCustomerGroup {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreateDiscountConditionCustomerGroup>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = DiscountConditionCustomerGroupActiveModel {
			customer_group_id: Set("id".to_string()),
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdateDiscountConditionCustomerGroup {
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
	pub metadata: Option<Json>,
}

impl UpdateDiscountConditionCustomerGroup {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionCustomerGroupParmns>,
		json_data: Option<web::Json<UpdateDiscountConditionCustomerGroup>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = DiscountConditionCustomerGroup::find_by_id((
			path.customer_group_id.clone(),
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: DiscountConditionCustomerGroupActiveModel = table.into();
					if let Some(created_at) = &model.created_at {
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeleteDiscountConditionCustomerGroup {
	pub customer_group_id: String,
	pub condition_id: String,
}

impl DeleteDiscountConditionCustomerGroup {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionCustomerGroupParmns>,
	) -> impl Responder {
		let res = DiscountConditionCustomerGroup::delete_by_id((
			path.customer_group_id.clone(),
			path.condition_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponseDiscountConditionCustomerGroup {
	pub customer_group_id: String,
	pub condition_id: String,
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
