...
#[derive(Deserialize)]
pub struct DiscountConditionProductParmns {
	product_id: String,
	condition_id: String,
}
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/discount_condition_product")
			.route("/", web::get().to(GetDiscountConditionProduct::route))
			.route("/", web::post().to(CreateDiscountConditionProduct::route))
			.route("/list", web::get().to(ListDiscountConditionProduct::route))
			.route("/{id}", web::put().to(UpdateDiscountConditionProduct::route))
			.route("/{id}", web::get().to(DeleteDiscountConditionProduct::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetDiscountConditionProduct {
...
impl GetDiscountConditionProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetDiscountConditionProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetDiscountConditionProduct::default(),
		};
		let mut query = DiscountConditionProduct::find();
		if let Some(product_id) = &model.product_id {
			query = query.filter(DiscountConditionProductColumn::ProductId.eq(product_id.clone()));
		}
		if let Some(condition_id) = &model.condition_id {
			query =
				query.filter(DiscountConditionProductColumn::ConditionId.eq(condition_id.clone()));
		}
		if let Some(created_at) = &model.created_at {
			query = query.filter(DiscountConditionProductColumn::CreatedAt.eq(created_at.clone()));
		}
		if let Some(updated_at) = &model.updated_at {
			query = query.filter(DiscountConditionProductColumn::UpdatedAt.eq(updated_at.clone()));
		}
		if let Some(metadata) = &model.metadata {
			query = query.filter(DiscountConditionProductColumn::Metadata.eq(metadata.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListDiscountConditionProduct {
	pub product_id: Option<String>,
	pub condition_id: Option<String>,
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
...
impl ListDiscountConditionProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListDiscountConditionProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListDiscountConditionProduct::default(),
		};
		let mut query = DiscountConditionProduct::find();
		if let Some(product_id) = &model.product_id {
			query = query.filter(DiscountConditionProductColumn::ProductId.eq(product_id.clone()));
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreateDiscountConditionProduct {
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
	pub metadata: Option<Json>,
}

impl CreateDiscountConditionProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreateDiscountConditionProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = DiscountConditionProductActiveModel {
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdateDiscountConditionProduct {
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
	pub metadata: Option<Json>,
}

impl UpdateDiscountConditionProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductParmns>,
		json_data: Option<web::Json<UpdateDiscountConditionProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = DiscountConditionProduct::find_by_id((
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: DiscountConditionProductActiveModel = table.into();
					if let Some(created_at) = &model.created_at {
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeleteDiscountConditionProduct {
	pub product_id: String,
	pub condition_id: String,
}

impl DeleteDiscountConditionProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductParmns>,
	) -> impl Responder {
		let res = DiscountConditionProduct::delete_by_id((
			path.product_id.clone(),
			path.condition_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponseDiscountConditionProduct {
	pub product_id: String,
	pub condition_id: String,
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
