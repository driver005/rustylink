...
#[derive(Deserialize)]
pub struct DiscountConditionProductTagParmns {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/discount_condition_product_tag")
			.route("/", web::get().to(GetDiscountConditionProductTag::route))
			.route("/", web::post().to(CreateDiscountConditionProductTag::route))
			.route("/list", web::get().to(ListDiscountConditionProductTag::route))
			.route("/{id}", web::put().to(UpdateDiscountConditionProductTag::route))
			.route("/{id}", web::get().to(DeleteDiscountConditionProductTag::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetDiscountConditionProductTag {
	pub product_tag_id: Option<String>,
...
impl GetDiscountConditionProductTag {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetDiscountConditionProductTag>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetDiscountConditionProductTag::default(),
		};
		let mut query = DiscountConditionProductTag::find();
		if let Some(product_tag_id) = &model.product_tag_id {
			query = query
				.filter(DiscountConditionProductTagColumn::ProductTagId.eq(product_tag_id.clone()));
		}
		if let Some(condition_id) = &model.condition_id {
			query = query
				.filter(DiscountConditionProductTagColumn::ConditionId.eq(condition_id.clone()));
		}
		if let Some(created_at) = &model.created_at {
			query =
				query.filter(DiscountConditionProductTagColumn::CreatedAt.eq(created_at.clone()));
		}
		if let Some(updated_at) = &model.updated_at {
			query =
				query.filter(DiscountConditionProductTagColumn::UpdatedAt.eq(updated_at.clone()));
		}
		if let Some(metadata) = &model.metadata {
			query = query.filter(DiscountConditionProductTagColumn::Metadata.eq(metadata.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListDiscountConditionProductTag {
	pub product_tag_id: Option<String>,
	pub condition_id: Option<String>,
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
...
impl ListDiscountConditionProductTag {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListDiscountConditionProductTag>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListDiscountConditionProductTag::default(),
		};
		let mut query = DiscountConditionProductTag::find();
		if let Some(product_tag_id) = &model.product_tag_id {
			query = query
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreateDiscountConditionProductTag {
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
	pub metadata: Option<Json>,
}

impl CreateDiscountConditionProductTag {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreateDiscountConditionProductTag>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = DiscountConditionProductTagActiveModel {
			product_tag_id: Set("id".to_string()),
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdateDiscountConditionProductTag {
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
	pub metadata: Option<Json>,
}

impl UpdateDiscountConditionProductTag {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductTagParmns>,
		json_data: Option<web::Json<UpdateDiscountConditionProductTag>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = DiscountConditionProductTag::find_by_id((
			path.product_tag_id.clone(),
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: DiscountConditionProductTagActiveModel = table.into();
					if let Some(created_at) = &model.created_at {
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeleteDiscountConditionProductTag {
	pub product_tag_id: String,
	pub condition_id: String,
}

impl DeleteDiscountConditionProductTag {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductTagParmns>,
	) -> impl Responder {
		let res = DiscountConditionProductTag::delete_by_id((
			path.product_tag_id.clone(),
			path.condition_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponseDiscountConditionProductTag {
	pub product_tag_id: String,
	pub condition_id: String,
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
