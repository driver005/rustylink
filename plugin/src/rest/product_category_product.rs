...
#[derive(Deserialize)]
pub struct ProductCategoryProductParmns {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/product_category_product")
			.route("/", web::get().to(GetProductCategoryProduct::route))
			.route("/", web::post().to(CreateProductCategoryProduct::route))
			.route("/list", web::get().to(ListProductCategoryProduct::route))
			.route("/{id}", web::put().to(UpdateProductCategoryProduct::route))
			.route("/{id}", web::get().to(DeleteProductCategoryProduct::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetProductCategoryProduct {
	pub product_category_id: Option<String>,
	pub product_id: Option<String>,
}

impl GetProductCategoryProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetProductCategoryProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetProductCategoryProduct::default(),
		};
		let mut query = ProductCategoryProduct::find();
		if let Some(product_category_id) = &model.product_category_id {
			query = query.filter(
				ProductCategoryProductColumn::ProductCategoryId.eq(product_category_id.clone()),
			);
		}
		if let Some(product_id) = &model.product_id {
			query = query.filter(ProductCategoryProductColumn::ProductId.eq(product_id.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListProductCategoryProduct {
	pub product_category_id: Option<String>,
	pub product_id: Option<String>,
}

impl ListProductCategoryProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListProductCategoryProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListProductCategoryProduct::default(),
		};
		let mut query = ProductCategoryProduct::find();
		if let Some(product_category_id) = &model.product_category_id {
			query = query.filter(
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreateProductCategoryProduct {}

impl CreateProductCategoryProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreateProductCategoryProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = ProductCategoryProductActiveModel {
			product_category_id: Set("id".to_string()),
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdateProductCategoryProduct {}

impl UpdateProductCategoryProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<ProductCategoryProductParmns>,
		json_data: Option<web::Json<UpdateProductCategoryProduct>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = ProductCategoryProduct::find_by_id((
			path.product_category_id.clone(),
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: ProductCategoryProductActiveModel = table.into();
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeleteProductCategoryProduct {
	pub product_category_id: String,
	pub product_id: String,
}

impl DeleteProductCategoryProduct {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<ProductCategoryProductParmns>,
	) -> impl Responder {
		let res = ProductCategoryProduct::delete_by_id((
			path.product_category_id.clone(),
			path.product_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponseProductCategoryProduct {
	pub product_category_id: String,
	pub product_id: String,
}
