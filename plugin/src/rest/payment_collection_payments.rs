...
#[derive(Deserialize)]
pub struct PaymentCollectionPaymentsParmns {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/payment_collection_payments")
			.route("/", web::get().to(GetPaymentCollectionPayments::route))
			.route("/", web::post().to(CreatePaymentCollectionPayments::route))
			.route("/list", web::get().to(ListPaymentCollectionPayments::route))
			.route("/{id}", web::put().to(UpdatePaymentCollectionPayments::route))
			.route("/{id}", web::get().to(DeletePaymentCollectionPayments::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetPaymentCollectionPayments {
	pub payment_collection_id: Option<String>,
	pub payment_id: Option<String>,
}

impl GetPaymentCollectionPayments {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetPaymentCollectionPayments>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetPaymentCollectionPayments::default(),
		};
		let mut query = PaymentCollectionPayments::find();
		if let Some(payment_collection_id) = &model.payment_collection_id {
			query = query.filter(
				PaymentCollectionPaymentsColumn::PaymentCollectionId
					.eq(payment_collection_id.clone()),
			);
		}
		if let Some(payment_id) = &model.payment_id {
			query = query.filter(PaymentCollectionPaymentsColumn::PaymentId.eq(payment_id.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListPaymentCollectionPayments {
	pub payment_collection_id: Option<String>,
	pub payment_id: Option<String>,
}

impl ListPaymentCollectionPayments {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListPaymentCollectionPayments>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListPaymentCollectionPayments::default(),
		};
		let mut query = PaymentCollectionPayments::find();
		if let Some(payment_collection_id) = &model.payment_collection_id {
			query = query.filter(
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreatePaymentCollectionPayments {}

impl CreatePaymentCollectionPayments {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreatePaymentCollectionPayments>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = PaymentCollectionPaymentsActiveModel {
			payment_collection_id: Set("id".to_string()),
			payment_id: Set("id".to_string()),
		};
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdatePaymentCollectionPayments {}

impl UpdatePaymentCollectionPayments {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<PaymentCollectionPaymentsParmns>,
		json_data: Option<web::Json<UpdatePaymentCollectionPayments>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = PaymentCollectionPayments::find_by_id((
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: PaymentCollectionPaymentsActiveModel = table.into();
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeletePaymentCollectionPayments {
	pub payment_collection_id: String,
	pub payment_id: String,
}

impl DeletePaymentCollectionPayments {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<PaymentCollectionPaymentsParmns>,
	) -> impl Responder {
		let res = PaymentCollectionPayments::delete_by_id((
			path.payment_collection_id.clone(),
			path.payment_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponsePaymentCollectionPayments {
	pub payment_collection_id: String,
	pub payment_id: String,
}
