...
#[derive(Deserialize)]
pub struct DiscountConditionProductTypeParmns {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
	cfg.service(
		web::scope("/discount_condition_product_type")
			.route("/", web::get().to(GetDiscountConditionProductType::route))
			.route("/", web::post().to(CreateDiscountConditionProductType::route))
			.route("/list", web::get().to(ListDiscountConditionProductType::route))
			.route("/{id}", web::put().to(UpdateDiscountConditionProductType::route))
			.route("/{id}", web::get().to(DeleteDiscountConditionProductType::route)),
	);
}

#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct GetDiscountConditionProductType {
...
impl GetDiscountConditionProductType {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<GetDiscountConditionProductType>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => GetDiscountConditionProductType::default(),
		};
		let mut query = DiscountConditionProductType::find();
		if let Some(product_type_id) = &model.product_type_id {
			query = query.filter(
				DiscountConditionProductTypeColumn::ProductTypeId.eq(product_type_id.clone()),
			);
		}
		if let Some(condition_id) = &model.condition_id {
			query = query
				.filter(DiscountConditionProductTypeColumn::ConditionId.eq(condition_id.clone()));
		}
		if let Some(created_at) = &model.created_at {
			query =
				query.filter(DiscountConditionProductTypeColumn::CreatedAt.eq(created_at.clone()));
		}
		if let Some(updated_at) = &model.updated_at {
			query =
				query.filter(DiscountConditionProductTypeColumn::UpdatedAt.eq(updated_at.clone()));
		}
		if let Some(metadata) = &model.metadata {
			query = query.filter(DiscountConditionProductTypeColumn::Metadata.eq(metadata.clone()));
		}
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ListDiscountConditionProductType {
	pub product_type_id: Option<String>,
	pub condition_id: Option<String>,
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
...
impl ListDiscountConditionProductType {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<ListDiscountConditionProductType>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => ListDiscountConditionProductType::default(),
		};
		let mut query = DiscountConditionProductType::find();
		if let Some(product_type_id) = &model.product_type_id {
			query = query.filter(
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CreateDiscountConditionProductType {
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
	pub metadata: Option<Json>,
}

impl CreateDiscountConditionProductType {
	async fn route(
		db: web::Data<DatabaseConnection>,
		json_data: Option<web::Json<CreateDiscountConditionProductType>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let new_table = DiscountConditionProductTypeActiveModel {
			product_type_id: Set("id".to_string()),
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct UpdateDiscountConditionProductType {
	pub created_at: Option<DateTimeWithTimeZone>,
	pub updated_at: Option<DateTimeWithTimeZone>,
	pub metadata: Option<Json>,
}

impl UpdateDiscountConditionProductType {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductTypeParmns>,
		json_data: Option<web::Json<UpdateDiscountConditionProductType>>,
	) -> impl Responder {
		let model = match json_data {
			Some(model) => model.into_inner(),
			None => return HttpResponse::InternalServerError().body("Empty body received"),
		};
		let old_table = DiscountConditionProductType::find_by_id((
			path.product_type_id.clone(),
		...
		match old_table {
			Ok(old) => match old {
				Some(table) => {
					let mut model_active: DiscountConditionProductTypeActiveModel = table.into();
					if let Some(created_at) = &model.created_at {
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct DeleteDiscountConditionProductType {
	pub product_type_id: String,
	pub condition_id: String,
}

impl DeleteDiscountConditionProductType {
	async fn route(
		db: web::Data<DatabaseConnection>,
		path: web::Path<DiscountConditionProductTypeParmns>,
	) -> impl Responder {
		let res = DiscountConditionProductType::delete_by_id((
			path.product_type_id.clone(),
			path.condition_id.clone(),
		))
		.exec(db.get_ref())
...
#[derive(Default, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ResponseDiscountConditionProductType {
	pub product_type_id: String,
	pub condition_id: String,
	pub created_at: DateTimeWithTimeZone,
	pub updated_at: DateTimeWithTimeZone,
