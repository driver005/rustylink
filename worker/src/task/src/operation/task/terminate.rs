...
use chrono::Utc;
use common::{Error, Result, TaskStatus, TaskTerminationStatus, TaskType};
...
pub struct Model {
	...
	pub id: Uuid,
	// The termination status for the current workflow. Accepted values:
	//  -  COMPLETED
	//  -  FAILED
	//  -  TERMINATED
	pub termination_status: TaskTerminationStatus,
	// The reason for terminating the current workflow, which will provide the context of the termination. It can be passed as a variable.
	pub termination_reason: Option<String>,
	// A map of the expected workflow output on termination. It can contain a string, number, boolean, null, or object/array.
